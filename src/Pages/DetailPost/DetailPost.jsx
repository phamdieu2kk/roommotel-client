                    ...
                    <div className={cx('left')}>
                        ...
                        <div className={cx('property-details')}>
                            <div className={cx('property-header')}>
                                {post?.typeNews === 'vip' && <span className={cx('vip-tag')}>TIN VIP</span>}
                    ...
                    <div className={cx('right')}>
                        ...
                        <div className={cx('featured-listings')}>
                            ...
                            {postVip.map((item, index) => (
                                <div className={cx('listing-item')} key={item._id}>
                                    <Link to={`/chi-tiet-tin-dang/${item._id}`} className={cx('listing-image')}>
